...
const Footer = () => {
  return (
    <footer className="border-t border-zinc-800 bg-zinc-900 py-12 md:py-16 text-zinc-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          <div className="md:col-span-1">
            ...
            <p className="text-zinc-400 text-sm mb-4">
              Elevate your coding skills with Zenx - the ultimate coding platform.
            </p>
          </div>
          ...
          <div className="md:col-span-3 grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/#features" className="text-zinc-400 hover:text-green-400 text-sm transition-colors">
                    Features
                  </Link>
                </li>
                <li>
                  <Link to="/leaderboard" className="text-zinc-400 hover:text-green-400 text-sm transition-colors">
                    Leaderboard
                  </Link>
                </li>
                <li>
                  <a href="#" className="text-zinc-400 hover:text-green-400 text-sm transition-colors">
                    Analytics
                  </a>
                </li>
                <li>
