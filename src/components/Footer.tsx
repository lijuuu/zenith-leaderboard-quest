  ...
  return (
    <footer className="border-t border-zinc-200 bg-white py-12 md:py-16">
      <div className="page-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          <div className="md:col-span-1">
            ...
            <p className="text-zinc-600 text-sm mb-4">
              Elevate your performance with Zenx - the ultimate analytics platform.
            </p>
          </div>
          ...
          <div className="md:col-span-3 grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/#features" className="text-zinc-600 hover:text-zenblue text-sm transition-colors">
                    Features
                  </Link>
                </li>
                <li>
                  <Link to="/leaderboard" className="text-zinc-600 hover:text-zenblue text-sm transition-colors">
                    Leaderboard
                  </Link>
                </li>
                <li>
                  <a href="#" className="text-zinc-600 hover:text-zenblue text-sm transition-colors">
                    Analytics
                  </a>
                </li>
                <li>
        ...
        <div className="mt-12 pt-8 border-t border-zinc-200 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-zinc-500 text-sm mb-4 sm:mb-0">
            &copy; {new Date().getFullYear()} Zenx. All rights reserved.
          </p>
          
          <div className="flex space-x-6">
            <a href="#" className="text-zinc-500 hover:text-zenblue transition-colors">
